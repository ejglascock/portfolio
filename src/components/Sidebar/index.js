...
import './index.scss';
import ejgLogo1 from '../../assets/images/ejgLogo1.png';
...
const Sidebar = () => {
    ...
    return (
        <div className='nav-bar'>
            ...
            <ul>
                <li>
                    <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/elijahglascock">
                        <FontAwesomeIcon icon={faLinkedin} color="#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target="_blank" rel="noreferrer" href="https://github.com/ejglascock">
